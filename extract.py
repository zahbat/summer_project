...
def write_to_file(t, probes, travg, vavg, file, fileWT):
...
def extraction(file,fileWT):
	...
	write_to_file(t, probes, travg, vavg, file, fileWT)
	
#extraction("cube_disp_5","points")
